...
def squad_convert_examples_to_features(
        ...
        regression=False, pq_end=False, sl=False,
):
    """
        ...
        if not is_training:
            ...
            if sl:
                ...
                dataset = TensorDataset(
                    all_input_ids, all_attention_masks, all_token_type_ids, all_example_index, all_is_impossibles,
                    all_tag_seq, all_cls_index, all_p_mask
                )
            else:
                dataset = TensorDataset(
                    all_input_ids, all_attention_masks, all_token_type_ids, all_example_index, all_is_impossibles,
