...
def getInputs(example, tokenizer, mask_padding_with_zero, max_length, pad_token, pad_token_segment_id, pad_on_left,
...
def glue_convert_examples_to_features(examples, tokenizer,
                                      ...
                                      mask_padding_with_zero=True, output_feature=False, pq_end=False,
                                      max_query_length=64):
    """
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        if pq_end:
            ...
            # hack here, q and p are written reversely to keep consistent with the modeling
        ...
        for entry in input_data:
            for paragraph in entry["paragraphs"]:
                ...
                for qa in paragraph["qas"]:
                    ...
                    examples.append(
                        InputExample(guid=qas_id, text_a=question_text, text_b=context_text, answer=answer_text,
                                     label=label))
        return examples
