...
from transformers import WEIGHTS_NAME, AlbertConfig, AlbertTokenizer
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {'input_ids': batch[0], 'attention_mask': batch[1], 'start_positions': batch[3],
                      'end_positions': batch[4], 'is_impossibles': batch[5], 'token_type_ids': batch[2]}
...
def main():
    ...
    model_class = AlbertForQuestionAnsweringAVPool
