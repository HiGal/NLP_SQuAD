...
class QuestionAnsweringArgumentHandler(ArgumentHandler):
    ...
    def __call__(self, *args, **kwargs):
        ...
        if 'X' in kwargs or 'data' in kwargs:
            ...
            inputs = [QuestionAnsweringPipeline.create_sample(q, c) for q, c in
                      zip(kwargs['question'], kwargs['context'])]
        else:
...
class QuestionAnsweringPipeline(Pipeline):
    ...
    @staticmethod
    def create_sample(question: Union[str, List[str]], context: Union[str, List[str]]) -> Union[
    ...
    def __call__(self, *texts, **kwargs):
        ...
        features = squad_convert_examples_to_features(examples, self.tokenizer, kwargs['max_seq_len'],
